...
module.exports = class extends Generator {
  ...
  initializing() {
    ...
    this.log(yosay(
      'Welcome to the ' + chalk.red('RV Angular Library') + ' generator!'
    ));
  }
  ...
  writing() {
    ...
    // Copy src folder
    if (!fs.exists(this.destinationPath('src'))) {
      this.fs.copy(
    ...
    if (!fs.exists(this.destinationPath('src/package.json'))) {
      this.fs.copyTpl(
    ...
    if (!fs.exists(this.destinationPath('src/tsconfig.es5.json'))) {
      this.fs.copyTpl(
    ...
    if (!fs.exists(this.destinationPath('src/tsconfig.spec.json'))) {
      this.fs.copyTpl(
